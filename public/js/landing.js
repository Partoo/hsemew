...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_scrollspy__ = __webpack_require__(102);
...
Vue.component('land', __webpack_require__(120));
var landing = new Vue({
  el: '#app'
});
...
function install(Vue, options) {
  ...
  function findElements(container, selector) {
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(container.querySelectorAll(selector)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var el = _step.value;
  ...
  function initScrollSections(el, sectionSelector) {
    ...
    var scrollSpyContextEl = el[scrollSpyContext];
    var idScrollSections = findElements(el, sectionSelector);
  ...
  Vue.directive('scroll-spy', {
    bind: function bind(el, binding, vnode) {
      function onScroll() {
        ...
        if (index !== currentIndex[id]) {
          ...
          if (typeof currentIndex !== 'undefined' && (0, _keys2.default)(activableElements).length > 0) {
      ...
      el[scrollSpyContext] = {
        onScroll: onScroll,
        options: (0, _assign2.default)({}, options, binding.value),
        id: scrollSpyId(el),
        eventEl: el,
        scrollEl: el
      };
    ...
    inserted: function inserted(el) {
      var sectionSelector = el[scrollSpyContext].options.sectionSelector;
    ...
    componentUpdated: function componentUpdated(el) {
      var _el$scrollSpyContext4 = el[scrollSpyContext],
          ...
          sectionSelector = _el$scrollSpyContext4.options.sectionSelector;
    ...
    unbind: function unbind(el) {
      var _el$scrollSpyContext5 = el[scrollSpyContext],
          eventEl = _el$scrollSpyContext5.eventEl,
          onScroll = _el$scrollSpyContext5.onScroll;
  ...
  function scrollSpyActive(el, binding) {
    var activeOptions = (0, _assign2.default)({}, options.active, binding.value);
  ...
  function initScrollActiveElement(el, activeOptions) {
    ...
    (0, _from2.default)(activableElements[id]).map(function (el) {
      el[scrollSpyContext] = {
  ...
  Vue.directive('scroll-spy-link', {
    inserted: function inserted(el, binding) {
      var linkOptions = (0, _assign2.default)({}, options.link, binding.value);
...
var _tween = __webpack_require__(119);
...
var update = __webpack_require__(29)("5494797c", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Carousel__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_GreatTab__ = __webpack_require__(133);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(29)("39a9806f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_easy_slider__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WxQr__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WxQr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__WxQr__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        WxQr: __WEBPACK_IMPORTED_MODULE_1__WxQr___default.a
    },
    computed: {
...
Component.options.__file = "resources/assets/js/components/WxQr.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e09576ce", Component.options)
  } else {
    hotAPI.reload("data-v-e09576ce", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    computed: {
        setSrc: function setSrc() {
            return 'https://open.weixin.qq.com/connect/qrconnect?appid=' + this.appid + '&scope=' + this.scope + '&redirect_uri=' + this.redirect_uri + '&state=' + this.state + '&href=' + this.href;
        }
    },
    props: {
        show_title: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e09576ce", module.exports)
  }
}
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("slider-item", [
            _c("section", { staticClass: "slider-inner" }, [
              _c(
                "a",
                { staticClass: "img-hover-enlarge", attrs: { href: "#" } },
                [_c("img", { attrs: { src: "/img/banner1.jpg", alt: "" } })]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "banner-slogan" }, [
                _c("p", [_vm._v("高效从容")]),
                _vm._v(" "),
                _c("p", [_vm._v("让工作变得有条不紊")])
              ])
            ])
          ])
        ],
          ...
          _vm.passed
            ? _c("div", { staticClass: "user-profile" }, [
                _c("img", {
                  ...
                  attrs: { src: _vm.userAvatar, alt: "User Thumb" }
                }),
                _vm._v(" "),
                _c("h5", { staticClass: "profile-name" }, [
                  _vm._v("您已经以" + _vm._s(_vm.userName) + "的身份登录")
                ]),
                _vm._v(" "),
                _vm._m(0)
              ])
            : _c("wx-qr", { staticStyle: { "text-align": "center" } })
        ],
        1
      )
    ],
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("ul", { staticClass: "profile-actions" }, [
      _c("li", [
      ...
      _vm._v(" "),
      _c("li", [
        _c("a", { staticClass: "button black", attrs: { href: "/logout" } }, [
          _vm._v("\n                        退出系统\n                    ")
        ])
      ])
    ])
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(29)("70ec49fa", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "columns three" }, [
      _c(
        "ul",
    ...
    _vm._v(" "),
    _c("div", { staticClass: "columns nine" }, [
          ...
          [
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "section-title" }, [
                _c("h4", [_vm._v(_vm._s(_vm.menus[1]))]),
                _vm._v(" "),
                _vm._m(1)
              ])
            ]),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "four columns" }, [
