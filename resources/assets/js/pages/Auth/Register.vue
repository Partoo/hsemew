<template>
    <div class="wm">
        ...
        <div style="text-align: center"><img :src="WxRespond.headimgurl" alt="user thumb">
            <h6>您将以{{WxRespond.nickname}}的身份注册</h6></div>
        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px"
            ...
            <el-row>
                <el-col :span="24">
                    <el-button type="primary" class="btn-block" @click.prevent="submitForm('ruleForm')">
                        完成绑定
                    </el-button>
                </el-col>
            </el-row>
            <el-row style="margin-top: 20px">
                <el-col :span="24">
                    <a href="/" class="align-right" style="margin-left: 20px;font-size: 12px">
                        使用其它微信号登录
                    </a>
...
<script>
    ...
    import {Form, Row, Col, FormItem, Input, MessageBox, Button} from 'element-ui'
